...
class Select2Mixin(object):
    ...
    def init_options(self):
        ...
        .. tip:: If you want to run ``Your_js_function`` in the context of the Select2 DOM element,
            ...
            use :py:class:`~.utils.JSFunctionInContext` instead of :py:class:`~.utils.JSFunction`.
        """
        pass
...
class AutoHeavySelect2Mixin(object):
    ...
    :py:func:`~.utils.register_field` when the Auto field is registered. The client side (DOM) sends this
